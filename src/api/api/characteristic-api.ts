...
export const CharacteristicApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async characteristicList(limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Characteristic>>> {
         ...
         * @throws {RequiredError}
         */
        async characteristicRead(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Characteristic>> {
...
export const CharacteristicApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        characteristicList(limit?: number, offset?: number, options?: any): AxiosPromise<Array<Characteristic>> {
         ...
         * @throws {RequiredError}
         */
        characteristicRead(id: number, options?: any): AxiosPromise<Characteristic> {
